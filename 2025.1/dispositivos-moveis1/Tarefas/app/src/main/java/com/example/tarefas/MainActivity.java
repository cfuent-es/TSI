...
public class MainActivity extends AppCompatActivity {
    ...
    class TarefaAdapter extends ArrayAdapter<Tarefa> {
        ...
        public View getView(int posicao, View view, ViewGroup parent) {
            ...
            switch( t.getPrioridade()) {
                case 'A' : ((TextView) view.findViewById(R.id.item_prioridade)).setText("Alta");
                break;
                case 'M' : ((TextView) view.findViewById(R.id.item_prioridade)).setText("Média");
                    break;
                case 'B' : ((TextView) view.findViewById(R.id.item_prioridade)).setText("Baixa");
                    break;
            }
            ((CheckBox) view.findViewById(R.id.item_feita)).setChecked(t.isFeita());
            return view;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            tarefas = (LinkedList<Tarefa>)
                    savedInstanceState.getSerializable("TAREFAS",
                            LinkedList.class);
        }
    ...
    public void remover(View v) {
        int pos = lista.getCheckedItemPosition();
        if (pos == -1) {
            Toast.makeText(this,"Selecione a tarefa a remover",
